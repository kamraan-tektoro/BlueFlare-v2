...
const GlobalReach: React.FC = () => {
  ...
  return (
    <Section id="global" className="bg-[#0f172a] relative overflow-hidden !py-14 !md:py-24">
      ...
      <div className="relative w-full max-w-6xl mx-auto h-[60vh] md:h-[80vh] bg-brand-navy/20 rounded-3xl border border-white/5 shadow-2xl backdrop-blur-sm overflow-hidden">
          ...
          <ErrorBoundary fallback={
            <div className="w-full h-full flex items-center justify-center text-white">
              <div className="text-center">
                <p className="text-xl mb-2">Globe Loading Error</p>
                <p className="text-sm text-gray-400">Please check the browser console for details</p>
              </div>
            </div>
          }>
